<div id="app">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center mt-2 mb-3"
                href="{{ route('home') }}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAttendances">
                    <i class="fas fa-building"></i>
                    <span>Attendances</span>
                </a>
                <div id="collapseAttendances" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">
                            Get
                        </h6>

                        <a class="collapse-item" href="{{ route('attendances.reports') }}">
                            Attendance Reports
                        </a>

                        <a class="collapse-item" href="{{ route('attendances.collect') }}">
        ...
        <li class="nav-item">
          ...
          <div id="collapseInterview" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            ...
            @canany(['Accept Student Enquiry ( PHP Bootcamp - YGN )', 'Accept Student Enquiry ( HR - YGN )', 'Accept
            Student Enquiry ( HR - MDY )', 'Accept Student Enquiry ( iOS - YGN )', 'Enroll Student ( PHP Bootcamp - YGN
            )', 'Enroll Student ( HR - YGN )', 'Enroll Student ( HR - MDY )', 'Enroll Student ( iOS - YGN )'])
            ...
            <li class="nav-item">
                ...
                <div id="collapseStudent" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @canany(['Accept Student Enquiry ( PHP Bootcamp - YGN )', 'Accept Student Enquiry ( HR - YGN )',
                        'Accept Student Enquiry ( HR - MDY )', 'Accept Student Enquiry ( iOS - YGN )'])
                        <a class="collapse-item" href="{{ route('student') }}">
                            Student
                        </a>
                        @endcanany

                        @canany(['Enroll Student ( PHP Bootcamp - YGN )', 'Enroll Student ( HR - YGN )', 'Enroll Student
                        ( HR - MDY )', 'Enroll Student ( iOS - YGN )'])
            ...
            <!-- Nav Item - Interview -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseInterview"
                    aria-expanded="true" aria-controls="collapseInterview">
                    <i class="fas fa-business-time"></i>
                    <span> Interview </span>
                </a>
                <div id="collapseInterview" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">
                            Job Appointment :
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{ URL::to('mmit_image/staff/'.$user->staff['photo']) }}"
                                    style="width: 3rem; height: 3rem">
                                @else
                                <img class="img-profile rounded-circle" src="{{ URL::to('mmit_image/staff/code.png') }}"
                                    style="width: 3rem; height: 3rem">
                                @endif
                            </a>
